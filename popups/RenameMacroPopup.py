from PyQt6.QtWidgets import QDialog, QVBoxLayout, QComboBox, QLabel, QDialogButtonBox, QLineEdit
...
class RenameMacroPopup(QDialog):
    ...
    def __init__(self, macro_list: QComboBox, parent=None):
        ...
        i = 0
        self.macro_choice_box = QComboBox()
        while macro_list.itemText(i) != "Create a macro":
            self.macro_choice_box.addItem(macro_list.itemText(i))
            i += 1
